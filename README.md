...
| [ListGameItem<br/>Template.xaml](UiIntegrationExamples/UiIntegrationFullscreenExample/ListGameItemTemplate.xaml) | Simple example for the ```SourceSelector``` on a game card in a fullscreen theme. |  |
| [GameDetails.xaml](UiIntegrationExamples/UiIntegrationFullscreenExample/GameDetails.xaml) | Example for a DetailsView in a fullscreen theme. |  |
