...
Some Themes ([Night](UiIntegrationExamples/ShowcaseThemeNight), [Day](UiIntegrationExamples/ShowcaseThemeDay), [Dawn](UiIntegrationExamples/ShowcaseThemeDawn), [Fullscreen](UiIntegrationExamples/ShowcaseThemeFullscreen)) showing some possibilites of using the custom ui elements provided by DuplicateHider.
