...
| [ListGameItem<br/>Template.xaml](UiIntegrationExamples/UiIntegrationFullscreenExample/ListGameItemTemplate.xaml) | Simple example for the ```SourceSelector``` on a game card in a fullscreen theme. | ![grafik](https://user-images.githubusercontent.com/24227002/113946791-8517f700-9809-11eb-8a61-3abfc9732c34.png) |
| [GameDetails.xaml](UiIntegrationExamples/UiIntegrationFullscreenExample/GameDetails.xaml) | Example for a DetailsView in a fullscreen theme. | ![grafik](https://user-images.githubusercontent.com/24227002/113946801-8ba66e80-9809-11eb-8a2e-b9b537d5a2be.png =20x) |
